...
<!-- TODO: add screenshots here, same style as your other repos.
     Suggested order: Login → Entry form → Journal (grid) → Row detail →
     PDF output → PDF list (with upload marks) → Fleet connection -->
...
📍 Charlotte, NC · [GitHub](https://github.com/baranDincsoy) · [LinkedIn](https://www.linkedin.com/)
